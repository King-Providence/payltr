export const companyHeroContent = {
  titleLine1: "We're Not A Lender.",
  titleLine2: "We're The Infrastructure Behind The Lender.",
  subtitle:
    "PayLTR is an Operational Liquidity Infrastructure Platform. We help SMEs detect, predict and solve temporary liquidity shortages — and we help the platforms that serve them offer financing without becoming lenders.",
...
export const companyStatsContent = {
  items: [
    { value: "€500K", label: "Max financing per SME" },
    { value: "120", label: "Day payment pause" },
    { value: "24mo", label: "Structured repayment" },
    { value: "5", label: "Steps from consent to capital" },
    { value: "0", label: "Lending licenses required for partners" },
    { value: "2x", label: "Average SME liquidity runway extended" },
  ],
};
...
export const companyCtaContent = {
  title: "Join the PayLTR ecosystem",
  description:
    "Whether you serve SMEs or run one yourself — embed liquidity where it matters most.",
  ctaSmes: "PayLTR For SMEs",
  ctaSmesHref: "/aanvragen",
  ctaPartner: "Become a Partner",
  ctaPartnerHref: "/partners",
};
