...
export const howItWorksJourneyContent = {
  ...
  steps: [
    ...
    {
      step: 2,
      kicker: "Integrate PayLTR & Offer Financing",
      title: "SEAMLESS FINANCING INTEGRATION",
      description:
        "Connect to PayLTR through a single API integration and instantly provide financing options to your merchants. Whether through your merchant portal, onboarding process, CRM, or dashboard, PayLTR makes it easy to embed funding opportunities directly into the customer experience.",
      bullets: [
        "Single API integration",
        "Quick and simple implementation",
        "Financing embedded within your platform",
        "White-label experience available",
        "Seamless merchant application flow",
      ],
    ...
    {
      step: 3,
      kicker: "Smart Eligibility",
      title: "INTELLIGENT MERCHANT ASSESSMENT",
      description:
        "Once an application is submitted, PayLTR automatically analyses merchant information and evaluates eligibility using advanced underwriting logic. The platform reviews business performance, cash flow, transaction activity, and funding requirements to identify the most suitable financing opportunities.",
      bullets: [
    ...
    },
    {
      step: 4,
      kicker: "Funding",
      title: "FAST ACCESS TO WORKING CAPITAL",
      description:
        "After approval, merchants receive funding offers tailored to their business needs. PayLTR works with a network of trusted funding partners to deliver flexible capital solutions that support growth, operations, inventory purchases, marketing initiatives, payroll, and expansion plans.",
      bullets: [
        "Approval notification delivered",
        "Flexible funding solutions available",
        "Multiple funding partners accessible",
        "Fast capital disbursement",
        "Repayment aligned with business cash flow",
      ],
    ...
    {
      step: 5,
      kicker: "Monitor Everything",
      title: "COMPLETE VISIBILITY & PERFORMANCE TRACKING",
      description:
        "Manage and monitor the entire funding lifecycle from a single partner dashboard. Track applications, approvals, funding activity, merchant performance, and portfolio insights in real time.",
      bullets: [
        "Real-time application tracking",
        "Approval and funding status monitoring",
