export const FAQHeroSectionContent = {
  ...
  lastContent: `"During your 90 or 120-day payment pause, a monthly user fee is charged by our licensed financial partner. Once repayments begin, you pay in 24 equal monthly instalments — completely interest-free. If you want to pay off your balance early, you can do so at any time with no extra charge."`,
  ...
  boxes: [
    {
      ...
      content:
        "Yes — the repayment period (months 1–24 after your deferral period ends) carries 0% interest. However, two costs apply during the deferral period: 1. A monthly user fee charged by our licensed financial partner) — this varies between 0.95% and 3.5% per month of the financed amount, depending on your risk profile. The exact amount is always shown before you accept. 2. A one-time PayLTR platform service fee — collected automatically via SEPA Direct Debit at the midpoint of your deferral period (day 45 for 90-day / day 60 for 120-day). The amount depends on your loan size and is clearly displayed before you submit your application. There are no other hidden fees. Early repayment carries no penalty.",
    },
    {
      question: "What is the user fee during the payment pause?",
      content:
        "The user fee is charged monthly by our licensed financial partner during your 90 or 120-day payment pause. It ranges from 0.95% to 3.5% per month of your financed amount, depending on your business risk profile — determined by our licensed financial partner's AI-powered credit assessment across 140+ data points. The exact monthly amount is always displayed clearly before you accept your offer."
    },
    {
    ...
    },
    {
      ...
      content:
        "If you are expecting a difficult month, contact us before your repayment date. We will do our best to find a solution. Late repayment terms are set by our licensed financial partner and are detailed in your financing agreement. We recommend reading your agreement carefully before signing.",
    },
  ],
};
...
export const applicationProcessfaq = {
  ...
  boxes: [
    ...
    },
    {
      ...
      content:
        "After your application is approved and your bank is verified, your financing is typically transferred within 24 hours. Exact timelines depend on your bank and our licensed financial partner.",
    },
  ],
};
  ...
  boxes: [
    {
      ...
      content:
        "PayLTR acts as the infrastructure layer between you (the SME) and the regulated funding partner that actually provides the capital. When you apply through PayLTR or a partner platform: 1. PayLTR collects your application and bank data via Open Banking (Ponto PSD2). 2. PayLTR runs a full in-house credit assessment using our own credit engine. 3. PayLTR routes the assessed application to our licensed financial partner for the final lending decision. 4. Our licensed financial partner approves and disburses the funds directly. 5. PayLTR manages fee collection and coordinates repayment tracking. PayLTR does not lend money directly and carries zero credit risk on its balance sheet.",
    },
    {
    ...
    },
    {
      ...
      content:
        "The financing is provided by our licensed financial partner, a licensed Dutch credit provider regulated under Dutch law. Our licensed financial partner makes the final credit decision and disburses the funds directly to your business bank account. Our licensed financial partner also absorbs all credit and default risk. PayLTR manages the origination, assessment, and orchestration — but the lending relationship is between you and our licensed financial partner.",
    },
    {
      question: "Is PayLTR a regulated financial institution?",
      content:
        "PayLTR operates as a credit intermediary and platform infrastructure provider. Under Dutch law (Wft), no AFM lending licence is required for B2B SME credit intermediation at entity level. Our licensed financial partner holds the relevant lending licence and regulatory authorisation. PayLTR is GDPR-compliant and operates within the applicable Dutch and EU regulatory frameworks.",
    },
  ],
};
...
export const partnerPlatformsFaq = {
  ...
  boxes: [
    ...
    },
    {
      ...
      content:
        "No. PayLTR connects your platform to our licensed financial partner, a licensed credit provider who holds the relevant regulatory authorisation. You act as a distribution channel — not a lender. You do not need a lending licence, you do not take on credit risk, and you do not need to build compliance or underwriting infrastructure.",
    },
    {
