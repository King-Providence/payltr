...
import { benefitsContent, getStartedContent, HelpComponentContent, HowItWorksHeroSectionContent, RealWorldScenerioContent, theChallengeContent, whyItsMattersContent } from "@/utils/usecase3";
...
export default function UseCaseInventoryPage() {
  return (
    <div className={styles.page}>
      ...
      <main className={styles.main} >        
        ...
        {/* <TrustedByBusinesses content={benefitsContent} /> */}
