...
import { benefitsContent, getStartedContent, HelpComponentContent, HowItWorksHeroSectionContent, RealWorldScenerioContent, theChallengeContent, whyItsMattersContent } from "@/utils/usecase4";
...
export default function UseCaseProjectsPage() {
  return (
